...
from .task import parse_response, request_bytes
...
def pulsar(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            print(f"------ Запрос request_bytes------ {form.data['request_bytes']}")
            print(f"------ Ответ response_bytes--------- {form.data['response_bytes']}")

            result = parse_response(response_bytes)
            print(f"-------: {result}")
